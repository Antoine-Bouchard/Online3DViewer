...
export class Website {
    constructor(parameters) {
        ...
        this.identificationTool = new IdentificationTool(this.viewer, this.settings);
    ...
    Resize() {
        ...
        this.identificationTool.Resize();
    }
    ...
    ClearModel() {
        ...
        this.identificationTool.SetActive(false);
    }
    ...
    OnModelClicked(button, mouseCoordinates) {
        ...
        if (this.identificationTool.IsActive()) {
            this.identificationTool.Click(mouseCoordinates);
            return;
        }
    ...
    OnModelMouseMoved(mouseCoordinates) {
        ...
        if (this.identificationTool.IsActive()) {
            this.identificationTool.MouseMove(mouseCoordinates);
        }
    }
    ...
    InitToolbar() {
        ...
        this.identificationTool.SetButton(identificationToolButton);
        AddSeparator(this.toolbar, ['only_full_width', 'only_on_model']);
    ...
    InitSidebar() {
        this.sidebar.Init({
            onEnvironmentMapChange: () => {
                ...
                if (this.identificationTool.IsActive()) {
                    this.identificationTool.UpdatePanel();
                }
            },
